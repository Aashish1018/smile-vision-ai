              ...
              {hasData && (
                <div className="bg-card-dark rounded-xl border border-black shadow-[2px_2px_0px_0px_rgba(45,60,45,1)] p-5 flex flex-col w-full">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button
                      onClick={() => window.open(`https://wa.me/?text=Check out my Dental Vision score: ${latestScore}/100! ${window.location.origin}/share/${dashData!.latest.id}`, "_blank", "noopener,noreferrer")}
                    ...
                    <button
                      onClick={() => window.open(`https://twitter.com/intent/tweet?text=Just+got+my+Dental+Vision+AI+smile+score:+${latestScore}/100!+✨&url=${window.location.origin}/share/${dashData!.latest.id}`, "_blank", "noopener,noreferrer")}
                    ...
                    <button
                      onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`${window.location.origin}/share/${dashData!.latest.id}`)}`, "_blank", "noopener,noreferrer")}
