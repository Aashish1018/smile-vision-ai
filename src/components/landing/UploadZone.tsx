  ...
  return (
    <section id="upload" className="py-20 px-4 md:px-12">
      <div className="max-w-[1380px] mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground text-center">Transform Your Smile Today</h2>
        <p className="text-muted-foreground text-center mt-3">Our advanced AI only needs one photo to show you the possibilities.</p>

        <div
          className="mt-12 border-2 border-dashed border-primary/30 rounded-2xl p-16 flex flex-col items-center gap-6 bg-card-dark/50 hover:border-primary/60 transition-colors cursor-pointer"
          onClick={onAuthOpen}
        >
          <span className="material-symbols-outlined text-primary text-6xl">cloud_upload</span>
          <p className="text-xl font-bold text-foreground">Drag and drop your photo here</p>
        ...
        <div className="mt-16">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="text-xl font-bold text-foreground">Tips for Best Results</h3>
          </div>
